...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = "Angular";
        this.availableRoom = 5;
        this.username = "input your name";
        this.showName = "input your name";
        this.isAdmin = true;
        this.guest = {
    ...
    AppComponent.prototype.getAvailableRoom = function () {
    ...
    AppComponent.prototype.checkAvailableRoom = function () {
...
module.exports = __webpack_require__(/*! /Users/niawjunior/Desktop/learn-ng/app3/src/main.ts */"./src/main.ts");
